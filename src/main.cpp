...
uint256 hashGenesisBlock("0xdf44942afa4963183827bad9e7d6d3844c19cb1a0e1ee270f283ea3268860ae1");
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Feb 19, 2014 10:00 something AM";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1392861817; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 491675;

        if (fTestNet)
        {
            block.nTime    = 1392861817;
            block.nNonce   = 0;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x41133b648a331fbdcb468bb705d84f5a8453dd384621c759d27a84d96aa7aa8e"));
